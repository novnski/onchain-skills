...
| description | string | No | A description for this stream | \`Monitor EVM activity\` |
...
| chainIds | array | No | The ids of the chains for this stream in hex Ex: ["0x1","0x38"] | \`["0x1"]\` |
...
```bash
curl -X POST "https://api.moralis-streams.com/streams/evm/YOUR_STREAM_ID" \
