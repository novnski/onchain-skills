...
|------|------|----------|-------------|----------|
| address | string | Yes | The wallet address token-transactions are to be retrieved for. | \`YOUR_ADDRESS\` |
...
```bash
curl -X GET "https://deep-index.moralis.io/api/v2.2/wallets/YOUR_ADDRESS/swaps?chain=eth&order=DESC" \
