...
| days | number | No | The number of days to look back to find the lowest price<br>If not provided 7 days will be the default and 365 is the maximum<br> | - |
...
```bash
curl -X GET "https://deep-index.moralis.io/api/v2.2/nft/YOUR_ADDRESS/1/price?chain=eth" \
