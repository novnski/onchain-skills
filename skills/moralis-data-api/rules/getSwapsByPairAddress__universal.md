...
```bash
curl -X GET "https://api.moralis.com/v1/chains/ethereum/pairs/YOUR_PAIR_ADDRESS/swaps?limit=100&transactionTypes=buy%2Csell%2CaddLiquidity%2CremoveLiquidity" \
