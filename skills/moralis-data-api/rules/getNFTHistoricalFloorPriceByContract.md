...
| interval | string (1d, 7d, 30d, 60d, 90d, 1y, all) | Yes | The duration to query | \`1d\` |
...
```bash
curl -X GET "https://deep-index.moralis.io/api/v2.2/nft/YOUR_ADDRESS/floor-price/historical?chain=eth&interval=1d" \
