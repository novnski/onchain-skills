...
| addresses | array | Yes | The addresses to get metadata for | \`YOUR_TOKEN_ADDRESS\` |
...
```bash
curl -X GET "https://deep-index.moralis.io/api/v2.2/erc20/metadata?chain=eth&addresses=YOUR_TOKEN_ADDRESS" \
