...
|------|------|----------|-------------|----------|
| address | string | Yes | The wallet address of the sender or recipient of the transfers | \`YOUR_ADDRESS\` |
...
```bash
curl -X GET "https://deep-index.moralis.io/api/v2.2/YOUR_ADDRESS/nft/transfers?chain=eth&format=decimal&order=DESC" \
